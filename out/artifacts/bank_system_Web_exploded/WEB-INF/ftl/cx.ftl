...
<div class="ns-container">
    <h1 style="text-align: center;margin-bottom: 20px">查询</h1>
    <form class="layui-form">
        ...
        <div class="layui-form-item " style="text-align: center">
            <button class="layui-btn" type="button" lay-submit lay-filter="sub">立即查询</button>
        </div>
    </form>
</div>
...
<script>
    ...
    layui.form.on('submit(sub)', function(data){
        ...
        console.log(data);
        layui.$.post("/work/cx",data.field,function (json) {
            console.info("服务器返回数据",json);
            if(json.code == "0"){
                /*SweetAlert2确定对话框*/
                swal({
                    type: 'success',
                    html: "<h2>"+json.count+"</h2>",
