...
<div class="ns-container">
    <h1 style="text-align: center;margin-bottom: 20px">转账</h1>
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layui-col-space5">
                <input name="outName" type="text"  lay-verify="required|mobile" placeholder="" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">转出金额</label>
            <div class="layui-input-block layui-col-space5">
        ...
        <div class="layui-form-item " style="text-align: center">
            <button class="layui-btn" type="button" lay-submit lay-filter="sub">确认转账</button>
        </div>
    </form>
</div>
...
<script>
    ...
    layui.form.on('submit(sub)', function(data){
        ...
        console.log(data);
        layui.$.post("/work/zz",data.field,function (json) {
