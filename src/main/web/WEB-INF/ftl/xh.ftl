...
<div class="ns-container">
    <h1 style="text-align: center;margin-bottom: 20px">销户</h1>
    <form class="layui-form">
        ...
        <div class="layui-form-item " style="text-align: center">
            <button class="layui-btn" type="button" lay-submit lay-filter="sub">确认销户</button>
        </div>
    </form>
</div>
...
<script>
    ...
    layui.form.on('submit(sub)', function(data){
        ...
        console.log(data);
        layui.$.post("/work/xh",data.field,function (json) {
