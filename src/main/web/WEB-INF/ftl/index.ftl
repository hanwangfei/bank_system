...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">银行办公系统</div>
        <!--右侧当前用户信息-->
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="http://www.wtu.edu.cn">
                    <!--图标-->
                    <span class="layui-icon layui-icon-user" style="font-size: 20px">
                    </span>
                    <!--用户信息-->
                    ${current_person.name}[${current_person.phoneNumber}]
                </a>
            </li>
            <!--注销按钮-->
    ...
    <div class="layui-footer">
        Copyright © wtu.hwf. All Rights Reserved.      qq:3059409726
    </div>
</div>
<!--LayUI JS文件-->
